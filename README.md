...
<td valign="top"><div align="center"><img src="./assets/animations/core-components.gif" width="200" alt="Components"></div><br><b>Essential building blocks:</b><br><ul><li>🏗️ <a href="./interview-prep/system-design/components/overview.md">Components Overview</a> ⭐</li><li>🔍 <a href="./README.md">Elasticsearch Suite</a> ⭐🆕<br>&nbsp;&nbsp;└ <a href="./interview-prep/system-design/components/search/elasticsearch-deep-dive.md">Hub</a> | <a href="./databases/elasticsearch/elasticsearch-research.md">Research</a> | <a href="./databases/elasticsearch/elasticsearch-internals-architecture.md">Internals</a></li><li>📨 <a href="./README.md">Kafka Suite</a> ⭐🆕<br>&nbsp;&nbsp;└ <a href="./kafka/kafka-deep-dive.md">Hub</a> | <a href="./kafka/kafka-fundamentals.md">Fundamentals</a> | <a href="./kafka/kafka-internals-architecture.md">Internals</a> | <a href="./kafka/avro-schema-mastery.md">Avro</a> | <a href="./kafka/kafka-connectors-guide.md">Connectors</a></li><li>🤖 <a href="./genai/genai-fundamentals.md">GenAI & LLMs</a> ⭐🆕</li><li>🚀 <a href="./devops/cicd-gitops-devops-mlops.md">DevOps & MLOps</a> ⭐🆕</li><li>🐘 <a href="./databases/04-postgresql-guide.md">PostgreSQL</a></li><li>🐬 <a href="./databases/05-mysql-indexing-sharding-partitioning.md">MySQL</a></li><li>🍃 <a href="./databases/06-mongodb-deep-dive.md">MongoDB</a></li><li>⚡ <a href="./databases/06b-dynamodb-deep-dive.md">DynamoDB</a></li><li>� <a href="./databases/07-oracle-deep-dive.md">Oracle</a></li><li>📡 <a href="./databases/08-event-driven-architecture.md">Event-Driven Architecture</a></li></ul></td>
</tr>
<tr>
<th>4. Cloud & AWS</th>
...
<tr>
<td valign="top"><div align="center"><img src="./assets/animations/projects.png" width="200" alt="Projects"></div><br><b>Practical Learning:</b><br><ul><li>📨 <a href="./projects/kafka-learning-project/README.md">Kafka Learning Project</a> ⭐</li><li>🤖 <a href="./projects/llm-finetuning-project/README.md">LLM Fine-Tuning</a></li><li>🔌 <a href="./projects/mcp-server-project/README.md">MCP Server Project</a></li><li>📚 <a href="./projects/rag-api-project/README.md">RAG API Project</a> ⭐</li><li>🗂️ <a href="./genai/agentic-ai-project-autowiki.md">AutoWiki for Git Project</a> ⭐🆕</li></ul></td>
<td valign="top"><div align="center"><img src="./assets/animations/genai.png" width="200" alt="GenAI"></div><br><b>AI/ML Engineering:</b><br><ul><li>🧠 <a href="./genai/ml-fundamentals.md">ML & DL Fundamentals</a> ⭐</li><li>🧠 <a href="./genai/genai-fundamentals.md">GenAI Fundamentals</a></li><li>📚 <a href="./genai/RAG-FineTuning-LLM-Mastery.md">RAG & Fine-Tuning Mastery</a> ⭐🆕</li><li>📐 <a href="./genai/VectorDatabases-Math-DeepDive.md">Vector DBs & Math Deep Dive</a> ⭐🆕</li><li>🤖 <a href="./genai/agentic-ai-guide.md">Agentic AI Guide</a> ⭐</li><li>🕸️ <a href="./genai/advanced-ai-frameworks.md">Advanced AI Frameworks</a> ⭐🆕</li><li>🔌 <a href="./genai/Model-Context-Protocol-MCP-Practical-Guide.md">MCP Practical Guide</a> ⭐🆕</li><li>🏗️ <a href="./genai/ai-harness-engineering.md">AI Harness Engineering</a> ⭐🆕</li><li>⚡ <a href="./genai/fastapi-guide.md">FastAPI for GenAI</a></li><li>📝 <a href="./genai/prompt-engineering.md">Prompt Engineering</a> ⭐🆕</li><li>🔍 <a href="./genai/rag-architecture.md">RAG Architecture & Chunking</a> ⭐🆕</li><li>🗄️ <a href="./genai/vector-search-qdrant.md">Vector Search (Qdrant)</a> ⭐🆕</li><li>⚙️ <a href="./genai/production-ingestion.md">Production Ingestion</a> ⭐🆕</li><li>📄 <a href="./genai/vectorless-indexing.md">Vectorless Indexing</a> ⭐🆕</li><li>🤖 <a href="./genai/agentic-workflows.md">Agentic Workflows</a> ⭐🆕</li><li>🧠 <a href="./genai/memory-layer.md">Agent Memory & Graph DBs</a> ⭐🆕</li><li>🔌 <a href="./genai/adapting-ai-ecosystem.md">AI Ecosystem & MCP</a> ⭐🆕</li><li>🐈 <a href="./genai/claude-101.md">Claude 101 & Agent SDK</a> ⭐🆕</li></ul></td>
...
<tr>
<td valign="top"><div align="center"><img src="./assets/animations/genai.png" width="200" alt="Claude Architect"></div><br><b>Exam Prep Materials:</b><br><ul><li>📖 <a href="./genai/claude/learning/README.md">Learning Materials Hub</a> ⭐</li><li>📋 <a href="./genai/claude/claude_architect_study_guide.md">Study Guide</a></li><li>🎯 <a href="./genai/claude/claude_architect_cheat_sheet.md">Cheat Sheet</a></li><li>📝 <a href="./genai/claude/claude_architect_practice_questions.md">Practice Questions (Set 1)</a></li><li>🔥 <a href="./genai/claude/claude_architect_advanced_questions.md">Advanced Questions (Set 2)</a></li></ul><b>Deep-Dive Topics:</b><br><ul><li>🏗️ <a href="./genai/claude/learning/01_agentic_architecture.md">Agentic Architecture (27%)</a></li><li>🔧 <a href="./genai/claude/learning/02_tool_design_mcp.md">Tool Design & MCP (18%)</a></li><li>⚙️ <a href="./genai/claude/learning/03_claude_code_config.md">Claude Code Config (20%)</a></li><li>💬 <a href="./genai/claude/learning/04_prompt_engineering.md">Prompt Engineering (20%)</a></li><li>🛡️ <a href="./genai/claude/learning/05_context_management.md">Context Management (15%)</a></li><li>⚠️ <a href="./genai/claude/learning/06_exam_strategy.md">Exam Strategy & Traps</a></li></ul></td>
