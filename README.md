...
<td valign="top"><div align="center"><img src="./assets/animations/interview-prep.png" width="200" alt="Interview"></div><br><b>Companies by Region:</b><br><ul><li>🇦🇺 <a href="./interview-prep/companies/australia/">Australia</a> (ANZ, NAB, REA)</li><li>🇮🇳 <a href="./interview-prep/companies/india/top-gurugram-companies.md">India (Gurugram)</a> ⭐</li><li>🇦🇪 <a href="./interview-prep/companies/uae/">UAE (Dubai)</a> ⭐</li></ul><b>DSA Resources:</b><br><ul><li>📋 <a href="./interview-prep/dsa/00-cheatsheet.md">Cheatsheet</a> ⭐</li><li>☕ <a href="./interview-prep/dsa/01-java-collections.md">Java Collections</a></li><li>📊 <a href="./interview-prep/dsa/02-dynamic-programming.md">Dynamic Programming</a></li><li>🕸️ <a href="./interview-prep/dsa/03-graph-algorithms.md">Graph Algorithms</a></li><li>🏢 <a href="./interview-prep/dsa/04-company-problems.md">Company Problems</a></li></ul></td>
</tr>
<tr>
