...
| 5-7 | ML Fundamentals (Regression, Classification) | [ML Fundamentals](../genai/ml-fundamentals.md) | Implement from scratch |
| 8-10 | Sklearn (Models, Pipelines, Feature Eng) | [ML Fundamentals](../genai/ml-fundamentals.md) | Kaggle competition |
| 11-14 | Evaluation Metrics, Cross-Validation | [ML Fundamentals](../genai/ml-fundamentals.md) | Model comparison project |

#### Week 3-4: Deep Learning & Frameworks

| Day | Topic | Resources | Practice |
|-----|-------|-----------|----------|
| 1-3 | Neural Networks Fundamentals | [DL Fundamentals](../genai/deep-learning-fundamentals.md) | Build MLP from scratch |
| 4-6 | PyTorch Basics (Tensors, Autograd, Training Loop) | [DL Fundamentals](../genai/deep-learning-fundamentals.md) | Custom dataset + model |
| 7-9 | CNNs, Transfer Learning | [DL Fundamentals](../genai/deep-learning-fundamentals.md) | Image classifier |
| 10-12 | Transformers Architecture | [GenAI Fundamentals](../genai/genai-fundamentals.md) | Attention from scratch |
| 13-14 | Hugging Face Ecosystem | [Fine-tuning Guide](../genai/fine-tuning-guide.md) | Fine-tune BERT |
...
| Day | Topic | Resources | Practice |
|-----|-------|-----------|----------|
| 1-3 | LLM Architecture (GPT, Claude, Llama) | [GenAI Fundamentals](../genai/genai-fundamentals.md) | Compare model outputs |
| 4-6 | Prompt Engineering Techniques | [GenAI Fundamentals](../genai/genai-fundamentals.md) | Build prompt library |
| 7-9 | Fine-tuning LLMs (LoRA, QLoRA) | [RAG & Fine-Tuning Mastery](../genai/RAG-FineTuning-LLM-Mastery.md) | Fine-tune Llama 3 |
| 10-12 | LangChain Basics | External: LangChain docs | Build a chain |
| 13-14 | OpenAI/Claude API Integration | [Agentic AI Guide](../genai/agentic-ai-guide.md) | Build chatbot |

#### Week 7-8: RAG & Agentic AI

| Day | Topic | Resources | Practice |
|-----|-------|-----------|----------|
| 1-4 | RAG Architecture & Implementation | [RAG & Fine-Tuning Mastery](../genai/RAG-FineTuning-LLM-Mastery.md) | Build RAG system |
| 5-7 | Vector Databases (HNSW, PQ, indexing) | [Vector DBs & Math Deep Dive](../genai/VectorDatabases-Math-DeepDive.md) | Index optimization |
| 8-10 | Advanced RAG (Hybrid, Reranking) | [RAG & Fine-Tuning Mastery](../genai/RAG-FineTuning-LLM-Mastery.md) | Production RAG API |
| 11-12 | Agentic AI Patterns | [Agentic AI Guide](../genai/agentic-ai-guide.md) | Build ReAct agent |
| 13-14 | MCP (Model Context Protocol) | [MCP Practical Guide](../genai/Model-Context-Protocol-MCP-Practical-Guide.md) | Build MCP server |
...
| Day | Topic | Resources | Practice |
|-----|-------|-----------|----------|
| 1-2 | FastAPI for ML APIs | [FastAPI Guide](../genai/fastapi-guide.md) | Build inference API |
...
| 7 | Model Monitoring & Observability | [AWS GenAI/MLOps](../genai/aws-genai-mlops.md) | Set up monitoring |

#### Week 10: Cloud ML Platforms

| Day | Topic | Resources | Practice |
|-----|-------|-----------|----------|
| 1-2 | AWS SageMaker | [AWS GenAI/MLOps](../genai/aws-genai-mlops.md) | Train model on SageMaker |
| 3-4 | AWS Bedrock & Lambda | [AWS GenAI/MLOps](../genai/aws-genai-mlops.md) | Deploy LLM endpoint |
| 5-6 | CI/CD for ML (MLflow, DVC) | [CI/CD GitOps DevOps MLOps](../devops/cicd-gitops-devops-mlops.md) | Build ML pipeline |
| 7 | Model Registry & Governance | [AWS GenAI/MLOps](../genai/aws-genai-mlops.md) | Set up registry |
...
📚 **Resources**: 
- [ML Fundamentals](../genai/ml-fundamentals.md)
- [Deep Learning Fundamentals](../genai/deep-learning-fundamentals.md)
...
📚 **Resources**:
- [GenAI Fundamentals](../genai/genai-fundamentals.md)
...
📚 **Resources**:
- [RAG Deep Dive](../genai/rag-deep-dive.md)
...
📚 **Resources**:
- [AWS GenAI/MLOps](../genai/aws-genai-mlops.md)
- [FastAPI Guide](../genai/fastapi-guide.md)
...
|----------|-------------|------|
| **ML Fundamentals** | Math, algorithms, sklearn | [View](../genai/ml-fundamentals.md) |
| **Deep Learning Fundamentals** | Neural networks, PyTorch | [View](../genai/deep-learning-fundamentals.md) |
| **GenAI Fundamentals** | LLMs, Transformers, prompting | [View](../genai/genai-fundamentals.md) |
| **RAG & Fine-Tuning Mastery** | 2026 Guide: RAG, PEFT, alignment | [View](../genai/RAG-FineTuning-LLM-Mastery.md) |
| **Vector DBs & Math Deep Dive** | HNSW, PQ, Similarity Math, Indices | [View](../genai/VectorDatabases-Math-DeepDive.md) |
| **Agentic AI Guide** | Agents, tools, planning patterns | [View](../genai/agentic-ai-guide.md) |
| **MCP Practical Guide** | MCP specs, servers, transport layers | [View](../genai/Model-Context-Protocol-MCP-Practical-Guide.md) |
| **AWS GenAI/MLOps** | SageMaker, Bedrock, deployment | [View](../genai/aws-genai-mlops.md) |
| **FastAPI Guide** | API development for AI | [View](../genai/fastapi-guide.md) |
